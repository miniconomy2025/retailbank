...
public class TransferService(ILedgerRepository ledgerRepository, IInterbankClient interbankClient, IOptions<TransferOptions> options, IOptions<SimulationOptions> simOptions)
{
